...
var port = process.env.PORT || 3081; // set our port
var staticdir = process.env.NODE_ENV === 'release' ? 'dist/rel' : 'dist/dev'; // get static files dir
...
// start app ===============================================
app.listen(port);                   // startup our app at http://localhost:3080
